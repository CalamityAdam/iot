...
-  **NB:** Important Change! You will need to specify the version of rails you are using
when inheriting from ActiveRecord::Migration in the migration generated by with the above
command.  Example: `AddImagesToUsers < ActiveRecord::Migration[5.1]`
